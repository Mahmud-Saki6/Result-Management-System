<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["search"])) {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            echo "No results found for Student Name: ".$studentNameToSearch;
        }
    }
?>
<!DOCTYPE html>
...
<body>
    ...
    <h2>Search Student Information</h2>
        Student Name to Search:<br>
        <input type="text" name="student_name_to_search"><br>
